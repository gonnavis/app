...
class UninterpolatedPlayer extends StatePlayer {
  ...
  static init() {
    this.actionInterpolants = {
      ...
      useTransition: new UniActionInterpolant(() => this.hasAction('use'), 0, defaultTransitionMaxTime),
      unuse: new InfiniteActionInterpolant(() => this.hasAction('unuse'), 0),
      unuseTransition: new UniActionInterpolant(() => this.hasAction('unuse'), 0, 2000),
