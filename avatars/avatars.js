...
class Avatar {
  ...
  update(timestamp, timeDiff) {
    ...
    window.domInfo.innerHTML = `
      ...
      <div style="display:none;">useType: --- ${this.useType}</div>
      ...
      <div style="display:;">unuseTime: --- ${Math.floor(this.unuseTime)}</div>
      ...
      <div style="display:;">blendList: --- ${this.blendList.map(applyFn=>applyFn.name.slice('applyFn'.length))}</div>
    `
